...
namespace BaiTapWeb.Migrations
{
    ...
    [Migration("20240413044501_LoginRequest")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaiTapWeb.Model.Courses", b =>
                {
            ...
            modelBuilder.Entity("BaiTapWeb.Model.StudentCourse", b =>
                {
            ...
            modelBuilder.Entity("BaiTapWeb.Model.Students", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BaiTapWeb.Model.User", b =>
                {
            ...
            modelBuilder.Entity("BaiTapWeb.Model.StudentCourse", b =>
                {
                    b.HasOne("BaiTapWeb.Model.Courses", "Course")
                        .WithMany("StudentCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BaiTapWeb.Model.Students", "Student")
                        .WithMany("StudentCourses")
